## The following two functions makeCacheMatrix and cacheSolve allow a user to save time by ## caching an inverse of a matrix rather than computing it repeatedly.
